...
/status	Returns full system status: gate state, slot count, temperature
/open	Manually opens the gate barrier (servo to 180°) and confirms via reply
/close	Manually closes the gate barrier (servo to 0°) and confirms via reply
/slots	Returns current available slot count and total capacity
/temp	Returns latest DHT11 temperature and humidity reading
...
Component	Notes
IR Sensor 1 	Parking slot 1
IR Sensor 2 	Parking slot 2
IR Sensor 3	Parking slot 3
LCD I2C	Display the slot counters , gate status
...
Component	Notes
TM1637 CLK	Slot counters
DHT11 DATA	Temperature and humidity
